...
await fetch(`https://raw.githubusercontent.com/05Konz/Blooket-Cheats/main/${isAuto ? "autoupdate" : "cheats"}/Bookmarklets.html`).then(async x => document.querySelector("#unobfuscated").contentDocument.write(await x.text().then(x => x.slice(0, x.indexOf("<style")))));
